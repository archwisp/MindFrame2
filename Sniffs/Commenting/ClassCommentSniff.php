...
if (class_exists('MindFrame2_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class MindFrame2_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class MindFrame2_Sniffs_Commenting_ClassCommentSniff extends MindFrame2_Sniffs_Commenting_FileCommentSniff
{
